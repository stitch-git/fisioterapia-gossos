...
export default function SuperHeader({ setSidebarOpen, sidebarOpen }) {
  ...
  return (
    <>
      <header className="bg-gradient-to-r from-purple-600 to-purple-800 text-white shadow-lg relative z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 lg:h-16">
            
            <div className="flex items-center">
              <button
                id="super-hamburger-button"
              ...
              <div className="flex items-center">
                <div className="h-8 w-8 lg:h-10 lg:w-10 bg-white rounded-full flex items-center justify-center mr-2 lg:mr-3">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs lg:text-sm text-purple-100">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              <div className="text-right hidden md:block">
                ...
                <p className="text-xs opacity-80">{profile?.nombre_completo || 'Super Admin'}</p>
              </div>
                ...
                {showProfileDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                    <div className="px-4 py-2 text-sm text-gray-700 border-b">
                      <p className="font-medium truncate">{profile?.nombre_completo || 'Super Admin'}</p>
